...
Single-file, compile-and-run versions of the 3 quick tutorials from the [README](../../README.en.md). CI builds and runs these on Windows/Linux/macOS, so the README code is guaranteed to work.
