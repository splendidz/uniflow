...
public:
    ...
    void OnAsyncAbandoned(std::string_view obj, std::string_view job,
                          double pending_ms) override;
    void OnAsyncHighWater(std::string_view obj, std::string_view job,
                          std::size_t inflight) override;
