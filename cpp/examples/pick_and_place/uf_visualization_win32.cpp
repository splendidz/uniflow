...
// Renders the pick-and-place line into a window. On non-Windows platforms this
// compiles to a no-op stub; the console back-end is used there instead.
...
static void DrawScene(HDC hdc, const RECT& rc)
{
...

    {
        ...
        COLORREF c =
            s.stage_state == StageState::Prepared           ? RGB(200, 120, 60) :
            s.stage_state == StageState::Machined           ? RGB(200, 120, 60) :
    ...
    const char* hdr = "uniflow pick & place line - LoadPicker / Stage / UnloadPicker, "
...
void RunVisualisationWin32()
{
    ...
    HWND hwnd = CreateWindowA(cls, "pick_and_place",
